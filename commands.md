...
This file was automatically generated at 16-02-2016 08:30:57 UTC.
## Preface
...
**Syntax:**
```- |userName| - replaced with the name of the user who triggered the event- |location| - replaced with the location (server or channel) where the event occured.``` | ServerModerator
