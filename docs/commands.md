...
This file was automatically generated at 18-02-2016 12:44:08 UTC.
...
`stream forcestop` | | Forcefully stops playback of the playlist, track and leaves the voice channel. | ChannelAdmin | ✓
...
`stream clear` | | Stops music and clears the playlist. | ServerModerator | ✓
